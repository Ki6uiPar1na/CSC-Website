export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-primary mb-8">About JKKNIU-CSC</h1>
      
      <div className="space-y-6">
        <div className="card border-border-color">
          <h2 className="text-2xl font-bold mb-8 text-center text-foreground">Our Mission</h2>
        ...
        <div className="card border-border-color">
          <h2 className="text-2xl font-bold mb-8 text-center text-foreground">What We Do</h2>
        ...
        <div className="card border-border-color">
          <h2 className="text-2xl font-bold mb-8 text-center text-foreground">University Identity</h2>
          <p className="text-gray-400 leading-relaxed text-sm sm:text-base">
