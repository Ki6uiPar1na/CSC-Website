...
const navItems: NavItem[] = [
  ...
  { label: "Events & News Update", href: "/admin/events", icon: <Calendar size={18} /> },
  ...
  { label: "CTFtime Events", href: "/admin/ctftime", icon: <Globe size={18} />, roles: [1] },
  ...
  { label: "Apply Forms", href: "/admin/recruitment", icon: <ClipboardList size={18} /> },
